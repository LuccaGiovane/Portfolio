...
const skills = [
  { name: 'C#', icon: '/icons/Csharp-icon.svg' },
  { name: '.NET', icon: '/icons/DotNet-icon.svg' },
  { name: 'Vue.js', icon: '/icons/Vue-icon.svg' },
  { name: 'Knockout.js', icon: '/icons/knockout-icon.svg' },
  { name: 'Python', icon: '/icons/Python-icon.svg' },
  { name: 'Django', icon: '/icons/Django-icon.svg' },
  { name: 'Flask', icon: '/icons/Flask-icon.svg' },
  { name: 'Pytest', icon: '/icons/Pytest-icon.svg' },
